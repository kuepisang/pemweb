...
@section('content')
    ...
    <center><div class="card mb-5" style="width: 18rem;">
        <img src="https://i.pinimg.com/474x/9c/b2/6e/9cb26eb99288274c6f6ce5e276884b8f.jpg" class="card-img-top" alt="Avatar">
        <div class="card-body">
          <h5 class="card-title">Ahmad Andri</h5>
          <p class="card-text">Saya Ahmad Andri dengan NIM 20200801177 Fakultas Ilmu Komputer.</p>
        </div>
      </div></center>
